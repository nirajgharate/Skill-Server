  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 pt-32 pb-24">
      ...
      >
        ...
        <div className="grid lg:grid-cols-[1.4fr_0.9fr] gap-8 mb-8">
            ...
            <div className="space-y-4">
              {previewImages.profilePhoto ? (
                ...
                >
                  ...
                  />
                  <div className="absolute inset-x-0 bottom-3 flex items-center justify-between gap-2 px-4">
        ...
        <div className="bg-white rounded-2xl p-8 border border-slate-100 shadow-lg mb-8">
          ...
          <p className="text-sm text-slate-600 mb-6">
            Upload your profile photo, aadhar card, and optional degree
            certificate to keep your profile complete.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-6">
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200">
              ...
              {previewImages.degreeCertificate ? (
                  ...
                  <div className="absolute inset-x-0 bottom-3 flex items-center justify-between gap-2 px-4">
                    <label className="inline-flex items-center gap-2 bg-white/90 text-slate-700 px-3 py-2 rounded-full border border-slate-200 cursor-pointer hover:bg-slate-50">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleFileUpload(e, "degreeCertificate")
                        }
                        className="hidden"
                      />
                    </label>
                ...
                <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-slate-300 rounded-lg cursor-pointer hover:border-indigo-600 hover:bg-indigo-50 transition-all">
